...
export const Main = ({ users, setUsers }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, documento, fechaIngreso, fechaSalida, sintomas].includes('')) {
      ...
      console.log(objetoUsers)
      setUsers([...users, objetoUsers])
  ...
  return (
    ...
    <div className='padreMain'>
      ...
      <form onSubmit={handleSubmit} className='mainForm' action="">
        ...
        <input id='documento' name='documento' onChange={(e) => setDocumento(e.target.value)} value={documento} type="number" placeholder='Ingrese documento' />
